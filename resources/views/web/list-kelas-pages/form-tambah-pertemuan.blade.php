...
@section('main')
    <form action="{{route('dosen-kelas.dosen-pertemuan.store', ['dosen_kela'=>$kelas->id])}}" method="POST">
        @csrf
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="mb-6 ">
                ...
                <input type="text" id="pertemuan" name="pertemuan"
                    ...
                    placeholder="Masukkan pertemuan" value="{{old('pertemuan')}}">
            </div>
            @error('pertemuan')
            ...
            <div class="mb-6">
                ...
                {{-- </div> --}}
                <input type="date" name="tanggal" id="tanggal" value="{{now()->toDateString()}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="mb-6">
                    ...
                    <select id="dropdownSelect" name="jenis"
                        ...
                        <option value="{{old('jenis')}}">Pilih jenis pertemuan</option>
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="mb-6">
                ...
                <select id="dropdownSelect" name="status" required
                    class="text-black bg-gray-50 hover:bg-gray-100 active:ring-4 active:outline-none active:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:active:ring-blue-800">
                    <option value="{{old('status')}}">Pilih status pertemuan</option>
            ...
            <div class="mb-6">
                ...
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                @error('materi') border-red-500 @enderror">{{ old('materi') }}</textarea>
            </div>
            @error('materi')
            <div class="text-red-500 text-sm mb-2">
                {{$message}}
